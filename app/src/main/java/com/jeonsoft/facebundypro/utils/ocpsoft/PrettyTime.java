 ...
 */
import com.jeonsoft.facebundypro.utils.ocpsoft.impl.DurationImpl;
import com.jeonsoft.facebundypro.utils.ocpsoft.impl.ResourcesTimeFormat;
import com.jeonsoft.facebundypro.utils.ocpsoft.impl.ResourcesTimeUnit;
import com.jeonsoft.facebundypro.utils.ocpsoft.units.*;
...
public class PrettyTime
{
    ...
    /**
     * Accept a {@link java.util.Date} timestamp to represent the point of reference for comparison. This may be changed by the
    ...
    /**
     * Construct a new instance using the given {@link java.util.Locale} instead of the system default.
     */
    ...
    /**
     * Accept a {@link java.util.Date} timestamp to represent the point of reference for comparison. This may be changed by the
     * user, after construction. Use the given {@link java.util.Locale} instead of the system default.
     * <p>
     * See {@code PrettyTime.setReference(Date timestamp)}.
     */
    ...
    /**
     * Get the currently configured {@link java.util.Locale} for this {@link com.jeonsoft.facebundypro.utils.ocpsoft.PrettyTime} object.
     */
    ...
    /**
     * Set the the {@link java.util.Locale} for this {@link com.jeonsoft.facebundypro.utils.ocpsoft.PrettyTime} object. This may be an expensive operation, since this
     * operation calls {@link TimeUnit#setLocale(java.util.Locale)} for each {@link TimeUnit} in {@link #getUnits()}.
     */
