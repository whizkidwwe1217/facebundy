package com.jeonsoft.facebundypro.utils.ocpsoft.format;
...
import com.jeonsoft.facebundypro.utils.ocpsoft.Duration;
import com.jeonsoft.facebundypro.utils.ocpsoft.TimeFormat;
...
public class SimpleTimeFormat implements TimeFormat
{
    ...
    /**
     * The percentage of the current {@link com.jeonsoft.ess.utils.ocpsoft.TimeUnit}.getMillisPerUnit() for which the quantity may be rounded up by one.
     *
