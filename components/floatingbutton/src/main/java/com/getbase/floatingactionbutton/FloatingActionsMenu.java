...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private Drawable mAddButtonIconDrawable;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mUseCustomDrawable = attr.getBoolean(R.styleable.FloatingActionsMenu_fab_useCustomDrawable, false);
